...
public class JpaWithExplicitEMForSingleTableInheritanceStrategy implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(JpaWithExplicitEMForSingleTableInheritanceStrategy.class, args);
    }
